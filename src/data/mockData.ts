...
export const mockColumnMappings: ColumnMapping[] = [
  {
    original_column: 'ID_Amostra',
    geo_parameter: 'sample_id',
    detected_type: 'text',
    sample_values: ['P-01', 'P-02', 'P-03'],
    confidence: 0.95,
  },
  {
    original_column: 'Data_Coleta',
    geo_parameter: 'collection_date',
    detected_type: 'date',
    sample_values: ['2025-01-15', '2025-01-16'],
    confidence: 0.98,
  },
  {
    original_column: 'Prof_m',
    geo_parameter: 'depth_m',
    detected_type: 'numeric',
    sample_values: ['45.2', '38.7', '52.1'],
    confidence: 0.92,
  },
  {
    original_column: 'pH',
    geo_parameter: 'ph',
    detected_type: 'numeric',
    sample_values: ['7.2', '6.8', '7.5'],
    confidence: 0.99,
  },
  {
    original_column: 'Cond_uS',
    geo_parameter: 'conductivity_us',
    detected_type: 'numeric',
    sample_values: ['680', '420', '780'],
    confidence: 0.88,
  },
  {
    original_column: 'STD_mg_L',
    geo_parameter: 'tds_mg_l',
    detected_type: 'numeric',
    sample_values: ['450', '280', '520'],
    confidence: 0.85,
  },
  {
    original_column: 'Calcio',
    geo_parameter: 'ca_meq_l',
    detected_type: 'numeric',
    sample_values: ['2.8', '1.2', '3.5'],
    confidence: 0.9,
  },
  {
    original_column: 'Magnesio',
    geo_parameter: 'mg_meq_l',
    detected_type: 'numeric',
    sample_values: ['1.5', '2.8', '1.2'],
    confidence: 0.9,
  },
  {
    original_column: 'Sodio',
    geo_parameter: 'na_meq_l',
    detected_type: 'numeric',
    sample_values: ['12.5', '8.2', '15.6'],
    confidence: 0.9,
  },
  {
    original_column: 'Potassio',
    geo_parameter: 'k_meq_l',
    detected_type: 'numeric',
    sample_values: ['0.8', '0.5', '1.2'],
    confidence: 0.88,
  },
  {
    original_column: 'Cloreto',
    geo_parameter: 'cl_meq_l',
    detected_type: 'numeric',
    sample_values: ['14.2', '9.5', '17.8'],
    confidence: 0.92,
  },
  {
    original_column: 'Sulfato',
    geo_parameter: 'so4_meq_l',
    detected_type: 'numeric',
    sample_values: ['1.2', '4.2', '0.9'],
    confidence: 0.91,
  },
  {
    original_column: 'Bicarbonato',
    geo_parameter: 'hco3_meq_l',
    detected_type: 'numeric',
    sample_values: ['3.5', '2.8', '4.1'],
    confidence: 0.89,
  },
]
...
export const mockProjects: Project[] = [
  {
    id: 'proj-001',
    name: 'Bacia do Paraná - Hidrogeoquímica',
    description: 'Análise de qualidade de água subterrânea em poços de monitoramento',
    created_at: '2025-01-10',
    updated_at: '2025-01-29',
    status: 'completed',
    sample_count: 12,
    universe: 'Hidrogeologia',
  },
  {
    id: 'proj-002',
    name: 'Serra do Curral - Geoquímica de Solo',
    description: 'Mapeamento de anomalias geoquímicas para prospecção mineral',
  ...
  {
    id: 'proj-003',
    name: 'Quadrilátero Ferrífero - Classificação Litológica',
    description: 'Identificação automatizada de tipos litológicos via ML',
    created_at: '2024-12-20',
    updated_at: '2025-01-25',
    status: 'completed',
    sample_count: 156,
    universe: 'Petrografia',
  },
  {
    id: 'proj-004',
    name: 'Bacia Amazônica - Sedimentologia',
    description: 'Análise granulométrica de sedimentos fluviais',
    created_at: '2025-01-20',
    updated_at: '2025-01-20',
    status: 'draft',
    sample_count: 0,
    universe: 'Sedimentologia',
  },
]
